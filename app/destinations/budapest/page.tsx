        ...
        <div className="min-h-screen">
            ...
            <div className="relative w-full h-[50vh] md:h-[65vh]">
                <Image
                    ...
                    alt="Ταξιδιωτικός οδηγός για τη Βουδαπέστη"
                    fill
                    priority
            ...
            <div className="pt-12 container mx-auto px-8 md:px-20 lg:px-60">
                ...
                <div className="mt-8">
                    ...
                    <ul className="list-disc pl-6 mb-4 space-y-3">
                        ...
                        <li>
                            Συνεχίστε στη πιο δημοφιλής εκκλησία της Βουδαπέστης, την <strong>Βασιλική του Αγίου Στεφάνου</strong>. Αξίζει να ανεβείτε μέχρι πάνω και δείτε την πόλη από ψηλά. Καλό θα ήταν να κλείσετε το εισητήρια σας από <a className="text-blue-600 underline" href='https://gyg.me/u6ys4Z7t'>εδώ</a>.
                        </li>
                ...
                <div className="mt-8">
                    ...
                    <div className="mb-6">
                        <ul className="list-disc pl-6 mb-4 space-y-3">
                            ...
                            <li>
                                Συνεχίστε με το <strong>κάστρο της Βούδας</strong>, το οποίο είναι στην ουσία ένα συγκρότημα παλατιών. Περιηγηθείτε στο εξωτερικό, εκεί βρήκαμε και ένα stand που είχε καφέ, κρασί και διάφορα παραδοσιακά φαγητά. Μέσα στο κάστρο υπάρχουν διάφορα μουσεία που μπορείτε να επισκεφτείτε όπως η <strong>Εθνική Πινακοθήκη της Ουγγαρίας</strong>. Μια άλλη ενδιαφέρον δραστηριότητα είναι να εξερευνήσετε τον <strong>λαβύρινθο κάτω από το κάστρο</strong>. Το κόστος είναι <strong>15€</strong> και εξαντλούνται πολύ γρήγορα τα <a className="text-blue-600 underline" href='https://gyg.me/9E6rYpJz'>εισιτήρια</a>.
                            </li>
                            ...
                            <li>
                                ...
                                Αρχικά μπήκαμε στην Εκκλησία το κόστος είναι περίπου <strong>8€</strong> και θα δείτε μια πολύ όμορφη εκκλησία τόσο εξωτερικά όσο και εσωτερικά. Μετά δείτε την θέα και βγάλτε πολλές φωτογραφίες στον Προμαχώνα των Ψαράδων. Ο προμαχώνας των Ψαράδων με τους 7 κωνικούς πύργους και σχεδιάστηκε να συμβολίζει τις 7 γενιές των Μαγυάρων που έφυγαν διωγμένοι από τους Ρώσους από τα Ουράλια Όροι και ήρθαν στην Ουγγαρία για ιδρύσουν αυτή τη χώρα.
                            </li>
