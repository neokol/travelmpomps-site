...
const barcelonaItems = [
    {
        ...
        content: 'Το νόμισμα που χρησιμοποιούν είναι η Λίρα (GBP). Η αναλογία μεταξύ ευρώ και λίρας είναι περίπου 1 GBP = 1.16 EUR',
    },
    {
        name: 'Roaming',
        ...
        <div className="min-h-screen">
            ...
            <div className="relative w-full h-[50vh] md:h-[65vh]">
                <Image
                    ...
                    alt="Ταξιδιωτικός οδηγός για το Λονδίνο"
                    fill
                    priority
            ...
            <div className="pt-12 container mx-auto px-8 md:px-20 lg:px-60">
                    ...
                    <div className="mb-6">
                        ...
                        <ul className="list-disc pl-6 space-y-3">
                            <li>
                                ...
                                Ενναλακτικά, η συμβουλή μας είναι να μην την παρακολουθήσετε εκεί που την παρακολουθούν όλοι οι άλλοι μπροστά από το Παλάτι του Μπάκιγχαμ, καθώς έχει πολύ κόσμο και δεν θα δείτε πολλά. Αντι αυτού, παρακολουθήστε την στο St. James Palace 15 λεπτά μετά την προγραμματισμένη τελετή.
                ...
                <div className="mt-8">
                    ...
                    <p className="mb-4 text-justify">
                        Συνεχίστε στην <strong>Millenium Bridge</strong> και μπροστά σας θα βρείτε το <strong>Tate Modern</strong>, ένα ακόμα δωρεάν μουσείο μοντέρνας τέχνης. Περιηγηθείτε για λίγο στο εσωτερικό προτού συνεχίσετε στο <strong>Shakespeares Globe</strong>, αντίγραφο από δρυ και άχυρο του αρχικού ελισαβετιανού θεάτρου, που παρουσιάζει έργα του Σαίξπηρ σε ανοιχτό χώρο.
                    </p>
                ...
                <div className="mt-8">
                    ...
                    <p className="mb-4 text-justify">
                        Οπότε, καλό θα ήταν να ξεκινήσετε από το <strong>Kings Cross Station</strong>. Είναι ο σταθμός που έφευγε το τρένο για το Hogwarts. Εδώ θα βρείτε το μαγαζί <strong>Harry Potter Shop Kings Cross</strong> όπου δίπλα του υπάρχει η χαρακτηριστική ταμπέλα με την πλατφόρμα <strong>9 ¾</strong> για να βγάλετε φωτογραφία. Αν έχει κόσμο αγνοήστε το καθώς υπάρχει παρόμοιο έκθεμα στα studios.
                    </p>
                ...
                <div className="mt-8">
                    ...
                    <div className="mb-4">
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            ...
                            <li><strong>Cyber Dog</strong>: Είναι ένα τεράστιο rave μαγαζί σε στιλ δεκαετίας του 90s, είναι ένα θέαμα που αξίζει να δείτε. Όλα είναι φωτεινά, υπάρχουν χορευτές στους τοίχους και η μουσική είναι δυνατή.</li>
                            <li><strong>Amy Winehouse</strong>: Η Έιμι Γουάινχαουζ κατάγεται από το Λονδίνο και το αποκαλεί σπίτι της. Ολόκληρη η περιοχή του Κάμντεν έχει μακρά ιστορία στη μουσική και, για αυτό, έχει απαθανατιστεί σε ένα άγαλμα της σε φυσικό μέγεθος, όπως και ένα υπέροχο graffiti.</li>
                            <li><strong>Regents Canal</strong>: Περπατήστε δίπλα από το κανάλι</li>
