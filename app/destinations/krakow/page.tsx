        ...
        <div className="min-h-screen">
            ...
            <div className="relative w-full h-[50vh] md:h-[65vh]">
                <Image
                    ...
                    alt="Ταξιδιωτικός οδηγός για την Κρακοβία"
                    fill
                    priority
            ...
            <div className="pt-12 container mx-auto px-8 md:px-20 lg:px-60">
                ...
                <TableOfContents items={krakowTocItems} />
                {/* Main sector */}
                ...
                <div id="imera-1" className="mt-8 scroll-mt-24">
                    ...
                    <ul className="list-disc pl-6 mb-4 space-y-3">
                        ...
                        <li>
                            <strong>Be Happy Museum Kraków</strong>: Είναι ένα διαδραστικό μουσείο το οποίο έχει διάφορα εκθέματα που βγάζεις φωτογραφίες. Μοιάζει αρκετά με το μουσείο of Illusions. Μπορείτε να κλείσετε εισιτήρια από <a className="text-blue-600 underline" href='https://gyg.me/gH85dGPx'>εδώ</a>.
                        </li>
                ...
                <div id="imera-2" className="mt-8 scroll-mt-24">
                    ...
                    <div className="mb-6">
                        ...
                        <div data-gyg-href="https://widget.getyourguide.com/default/activities.frame" data-gyg-locale-code="el-GR" data-gyg-widget="activities" data-gyg-number-of-items="1" data-gyg-partner-id="0OAQQKO" data-gyg-tour-ids="92097"><span>Powered by <a target="_blank" rel="sponsored" href="https://www.getyourguide.com/krakow-l40/">GetYourGuide</a></span></div>
                        <p className="mb-4 text-justify">
